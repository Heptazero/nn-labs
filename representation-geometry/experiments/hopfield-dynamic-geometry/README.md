...
- `experiment_05_multimemory_rank_collapse.py` and its `_colab.ipynb`: matched-IPR
  ...
  05B was not run.
- `experiment_05R_per_cue_ipr_matching.py` and its `_colab.ipynb`: exploratory
  method pilot prompted by a post-05A interaction pattern. It independently solves
