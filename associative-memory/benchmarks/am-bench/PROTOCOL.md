...
- `../../reproductions/1982-hopfield-emergent-computation/`：经典模型验收与论文专属动力学。
- `../../reproductions/1985-hopfield-spin-glass/`：容量定义、FM/SG 与零温理论基准。
- `../../reproductions/2020-hopfield-networks-is-all-you-need/`：经典、Dense、Continuous Modern 的共同图像接口。
- `../../reproductions/2025-hopfield-fenchel-young/`：softmax/sparsemax 容量与 margin 机制。
